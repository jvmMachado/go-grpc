...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CategoryList, error)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*CategoryList, error) {
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *empty.Empty) (*CategoryList, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *empty.Empty) (*CategoryList, error) {
...
func _CategoryService_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategories(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
